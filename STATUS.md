...
### Доменные сущности
_Являются своеобразным ядром. Не имеют никаких зависимостей извне множества доменных сущностей._
...
__Интерфейс сервиса авторизации__ _Определяет интерфейс для логики авторизации поьзователя_
...
- Проверить имеет ли доступ пользователь к карточке/списку/доске
