...
**Список** — упорядоченный контейнер, куда помещаются *карточки*. Используется для группировки *карточек* по какому-либо признаку, например по
...
- Создавать между карточками древоподобной зависимости и представление её в _режиме иерархий_
