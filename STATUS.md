...
---
__Словарь доступа__
_Служит для определения доступа конкретных пользователей к конкретным спискам_
* Словарь вида: список(сущность) - массив моделей менеджера доступа (пользователь, права записи и чтения)

---
__Словарь принадлежности__
_Служит для определения кому принадлежит определенная карточка_
* Словарь вида: карточка - массив пользователей

---
__Менеджер планирования__
_Служит для создания повторяющихся карточек, а так же для уведомления о конце срока выполнения_
 * Массив моделей менеджера планирования
  * Дата начала повторов
  * Период повторения
  * Дата окончания повторов

---
__Менеджер аутентификации__

---

__Провайдер__
_Главная сущность модели, которая отвечает за запуск всех менеджеров_
...
2. GUI в веб-версии
1. Хранение всех данных в базе данных
2. Клиентский API

## Сроки

1. __Базовый прототип с основными логическими структурами__ — начало апреля
